        ...
        <div class="content">
            <nav>
                ...
                <ul>                    
                    ...
                    <li>
                        <router-link to="/achados">Achados</router-link>
                    </li>
                    <li>
            ...
            <div class="header-block">
                <div class="text">
                    <h2>
                        Serviço gratuito para ajuda <br> a encontrar itens perdidos 
                    </h2>
                    <p>
                        Seu item perdido pode estar por aqui! <br> Cadastre as informaçoes no site: <br>
